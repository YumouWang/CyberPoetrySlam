...
public class WordViewTest {
    ...
    public void testGetAbstractWord() throws Exception {
        // All of our AbstractWordView implementations overload the getWord() method,
        // So to test that method we create an implementation of the AbstractWordView
        // class and call getWord() on it
        class TestAbstractWordView extends AbstractWordView {
            public TestAbstractWordView(AbstractWord word, Position position) {super(word, position);}
            @Override
            public boolean moveTo(Position toPosition) {return false;}
            @Override
            public AbstractWordView getSelectedElement(ConnectionBox box) {return null;}
            @Override
            public boolean contains(AbstractWordView otherWord) {return false;}
            @Override
