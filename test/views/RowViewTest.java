...
public class RowViewTest {
	...
	public void testAddWord() throws Exception {
		...
		assertEquals(rowView.getPosition().getX() + wordViewOne.width
				+ wordViewTwo.width, wordViewThree.getPosition().getX());
		assertEquals(rowView.getPosition().getY(), wordViewThree.getPosition()
				.getY());
	}
	...
	public void testAddWordToFront() throws Exception {
		...
		assertTrue(rowView.contains(wordViewThree));
		assertEquals(rowView.getPosition().getX(), wordViewThree.getPosition()
				.getX());
		assertEquals(rowView.getPosition().getY(), wordViewThree.getPosition()
				.getY());
	}
	...
	public void testAddRow() throws Exception {
		...
		assertEquals(rowView.getPosition().getX() + wordViewOne.width
				+ wordViewTwo.width, wordViewThree.getPosition().getX());
		assertEquals(rowView.getPosition().getX() + wordViewOne.width
				+ wordViewTwo.width + wordViewThree.width, wordViewFour
				.getPosition().getX());
		assertEquals(rowView.getPosition().getY(), wordViewThree.getPosition()
				.getY());
		assertEquals(rowView.getPosition().getY(), wordViewFour.getPosition()
				.getY());
	}
	...
	public void testRemoveWordViewStart() throws Exception {
		...
		assertEquals(wordViewTwo.getPosition().getX(), rowView.getPosition()
				.getX());
		assertEquals(wordViewTwo.getPosition().getY(), rowView.getPosition()
				.getY());
	...
	public void testRemoveWordViewEnd() throws Exception {
		...
		assertTrue(rowView.contains(wordViewTwo));
		assertFalse(rowView.contains(wordViewThree));
		assertEquals(wordViewOne.getPosition().getX(), rowView.getPosition()
				.getX());
		assertEquals(wordViewOne.getPosition().getY(), rowView.getPosition()
				.getY());
	...
	public void testRemoveWordViewFail() throws Exception {
		...
		assertEquals(wordViewOne.getPosition().getY(), rowView.getPosition()
				.getY());
		assertEquals(wordViewTwo.width + wordViewOne.width
				+ wordViewThree.width, rowView.width);
	}
	...
	public void testGetSelectedElementMultipleElements() throws Exception {
		ConnectionBox box = new ConnectionBox(new Position(10, 10), 300, 5);
		AbstractWordView selectedElement = rowView.getSelectedElement(box);
	...
	public void testVisitorPatternAbstractRow() throws Exception {
		...
		AbstractWordView abstractWordViewOne = new RowView(row, new Position(0,
				0), mainView);
	...
	public void testVisitorPatternPoem() throws Exception {
		...
		assertTrue(poemView.getRowViews().get(0)
				.acceptVisitor(disconnector, poemView));
	}
