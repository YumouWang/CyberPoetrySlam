...
public class DisconnectVisitorTest {
    ...
    @Test
     public void testVisitRowWordEdgeDisconnect() throws Exception {
        ...
        assertTrue(protectedArea.getAbstractWordCollection().contains(rowWordOne));
        assertTrue(protectedArea.getAbstractWordCollection().contains(rowWordTwo));
    ...
    public void testVisitRowWordMiddleDisconnect() throws Exception {
        ...
        assertTrue(protectedArea.getAbstractWordCollection().contains(rowWordOne));
        assertTrue(protectedArea.getAbstractWordCollection().contains(rowWordTwo));
        assertTrue(protectedArea.getAbstractWordCollection().contains(rowWordThree));
        assertFalse(protectedArea.getAbstractWordCollection().contains(rowOne));
        assertTrue(mainView.getProtectedAreaWords().contains(rowWordViewOne));
        assertTrue(mainView.getProtectedAreaWords().contains(rowWordViewTwo));
    ...
    public void testVisitPoemWordEdgeDisconnect() throws Exception {
        ...
        assertTrue(protectedArea.getAbstractWordCollection().contains(poemWordOne));
        assertTrue(protectedArea.getAbstractWordCollection().contains(poemWordTwo));
    ...
    @Test
    public void testVisitPoemWordMiddleUnsuccessfulDisconnect() throws Exception {
        VerticalConnectionVisitor verticalConnectionVisitor = new VerticalConnectionVisitor(mainView, gameState);
        HorizontalConnectionVisitor horizontalConnectionVisitor = new HorizontalConnectionVisitor(mainView, gameState);
    ...
    public void testVisitPoemWordMiddleDisconnect() throws Exception {
        VerticalConnectionVisitor connectionVisitor = new VerticalConnectionVisitor(mainView, gameState);
        ...
        assertTrue(protectedArea.getAbstractWordCollection().contains(poemWordOne));
        assertTrue(protectedArea.getAbstractWordCollection().contains(poemWordTwo));
        assertTrue(protectedArea.getAbstractWordCollection().contains(poemWordThree));
        assertFalse(protectedArea.getAbstractWordCollection().contains(poemOne));
        assertTrue(mainView.getProtectedAreaWords().contains(poemWordViewOne));
        assertTrue(mainView.getProtectedAreaWords().contains(poemWordViewTwo));
    ...
    public void testReducePoemToWordIfPossible() throws Exception {
        ...
        assertFalse(gameState.getProtectedArea().getAbstractWordCollection().contains(poem));
    ...
    public void testReduceRowToWordIfPossible() throws Exception {
        ...
        assertFalse(gameState.getProtectedArea().getAbstractWordCollection().contains(row));
        assertTrue(gameState.getProtectedArea().getAbstractWordCollection().contains(word));
    }
