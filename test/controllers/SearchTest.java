...
public class SearchTest {
	...
	public void test() {
		...
		String wordType = ((Word) result.iterator().next()).getType()
				.toString();
		...
		String wordType1 = ((Word) result1.iterator().next()).getType()
				.toString();
		...
		String wordType3 = ((Word) result3.iterator().next()).getType()
				.toString();
